...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/bank-logos` | `npm install @voxgig-sdk/bank-logos` |
| Python | `voxgig-sdk-bank-logos` | `pip install voxgig-sdk-bank-logos` |
| PHP | `voxgig-sdk/bank-logos` | `composer require voxgig-sdk/bank-logos` |
| Golang | `github.com/voxgig-sdk/bank-logos-sdk/go` | `go get github.com/voxgig-sdk/bank-logos-sdk/go` |
| Ruby | `voxgig-sdk-bank-logos` | `gem install voxgig-sdk-bank-logos` |
| Lua | `voxgig-sdk-bank-logos` | `luarocks install voxgig-sdk-bank-logos` |
