...
func (sdk *BankLogosSDK) OptionsMap() map[string]any {
...
func (sdk *BankLogosSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *BankLogosSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *BankLogosSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *BankLogosSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *BankLogosSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *BankLogosSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("BankLogosSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *BankLogosSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *BankLogosSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("BankLogosSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
