...
from banklogos_sdk.utility import register

# Load features
from banklogos_sdk.feature.base_feature import BankLogosBaseFeature
from banklogos_sdk.features import _has_feature, _make_feature
...
class BankLogosSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = BankLogosUtility()
        self._utility = utility

        from banklogos_sdk.config import shared_config
    ...
    def get_utility(self):
        return BankLogosUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("BankLogosSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Logo(self, data=None) -> "LogoEntity":
        ...
        from banklogos_sdk.entity.logo_entity import LogoEntity
