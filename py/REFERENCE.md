# BankLogos Python SDK Reference

Complete API reference for the BankLogos Python SDK.
...
#### `BankLogosSDK.test(testopts=None, sdkopts=None)`
...
```python
result = client.Logo().load({"bank": "bank"})
```
