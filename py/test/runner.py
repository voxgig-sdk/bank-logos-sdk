...
class BankLogosTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = BankLogosTestRunner.getenv("BANKLOGOS_TEST_LIVE")
        override = BankLogosTestRunner.getenv("BANKLOGOS_TEST_OVERRIDE")
        ...
        explain = BankLogosTestRunner.getenv("BANKLOGOS_TEST_EXPLAIN")
