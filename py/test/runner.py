...
class BankLogosTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = BankLogosTestRunner.getenv("BANK_LOGOS_TEST_LIVE")
        override = BankLogosTestRunner.getenv("BANK_LOGOS_TEST_OVERRIDE")
        ...
        explain = BankLogosTestRunner.getenv("BANK_LOGOS_TEST_EXPLAIN")
