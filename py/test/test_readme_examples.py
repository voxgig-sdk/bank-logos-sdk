# BankLogos SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BankLogosSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BankLogosSDK(...) and BankLogosSDK.test(...) become
#      BankLogosSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "banklogos_sdk"
_SDK_CLASS = "BankLogosSDK"
