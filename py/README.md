# BankLogos Python SDK



The Python SDK for the BankLogos API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Logo()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/bank-logos-sdk/releases)) or
...
```
py/
├── banklogos_sdk.py         -- Main SDK module
