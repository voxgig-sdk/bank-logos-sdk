...
function envOverride(m) {
    if ('TRUE' === process.env.BANK_LOGOS_TEST_LIVE ||
        'TRUE' === process.env.BANK_LOGOS_TEST_OVERRIDE) {
    ...
    m.BANK_LOGOS_TEST_EXPLAIN = process.env.BANK_LOGOS_TEST_EXPLAIN || m.BANK_LOGOS_TEST_EXPLAIN;
    return m;
}
