...
(0, node_test_1.describe)('LogoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.BankLogosSDK({
    ...
    (0, node_test_1.test)('direct-load-logo', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-logo', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.BANK_LOGOS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.BankLogosSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.BANK_LOGOS_APIKEY,
        }));
        let idmap = env['BANK_LOGOS_TEST_LOGO_ENTID'];
    ...
    const client = new __1.BankLogosSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=LogoDirect.test.js.map