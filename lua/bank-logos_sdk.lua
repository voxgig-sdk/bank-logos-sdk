...
local BankLogosSDK = {}
BankLogosSDK.__index = BankLogosSDK
...
BankLogosSDK._make_feature = _make_feature


function BankLogosSDK.new(options)
  local self = setmetatable({}, BankLogosSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function BankLogosSDK:options_map()
...
function BankLogosSDK:get_utility()
  return Utility.copy(self._utility)
end


function BankLogosSDK:get_root_ctx()
  return self._rootctx
end


function BankLogosSDK:prepare(fetchargs)
...
function BankLogosSDK:direct(fetchargs)
...
-- by passing it.
function BankLogosSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function BankLogosSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "BankLogosSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function BankLogosSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = BankLogosSDK.new(sdkopts)
  sdk.mode = "test"
