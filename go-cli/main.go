// Command BankLogos-cli is a CLI + REPL for the BankLogos SDK,
...
const prompt = "bank-logos"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "logo"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      BANK_LOGOS_APIKEY (api key), BANK_LOGOS_BASE (base url override)")
