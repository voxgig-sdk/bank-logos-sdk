...
func registerSDKWords(r *eng.Registry, client *sdk.BankLogosSDK) {
...
func runOp(client *sdk.BankLogosSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
