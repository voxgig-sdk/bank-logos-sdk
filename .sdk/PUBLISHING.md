...
|---|---|---|
| `ts/` | @voxgig-sdk/bank-logos-sdk | `.github/workflows/publish-ts.yml` |
...
`ts` target it runs:
    ...
    npm trust github @voxgig-sdk/bank-logos-sdk \
      --repository voxgig-sdk/bank-logos-sdk \
      --file publish-ts.yml \
      --allow-publish
...
`npm trust list @voxgig-sdk/bank-logos-sdk` shows the configuration, and
`npm trust revoke @voxgig-sdk/bank-logos-sdk --id=<id>` removes one.
