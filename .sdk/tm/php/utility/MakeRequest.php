...
// BankLogos SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class BankLogosMakeRequest
{
    public static function call(BankLogosContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new BankLogosResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new BankLogosResponse($fetched);
        } else {
