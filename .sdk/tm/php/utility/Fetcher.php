...
class BankLogosFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BankLogosSDK/1.0)';
    ...
    public static function call(BankLogosContext $ctx, string $fullurl, array $fetchdef): array
    {
