...
class BankLogosCacheFeature extends BankLogosBaseFeature
{
    ...
    private function _through(BankLogosContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
