...
// BankLogos SDK ratelimit feature
...
class BankLogosRatelimitFeature extends BankLogosBaseFeature
{
    ...
    private function _acquire(BankLogosContext $ctx): void
    {
    ...
    private function _track(BankLogosContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
