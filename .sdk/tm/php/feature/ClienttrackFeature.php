...
// BankLogos SDK clienttrack feature
...
class BankLogosClienttrackFeature extends BankLogosBaseFeature
{
    ...
    public function PostConstruct(BankLogosContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'BankLogos-SDK';
