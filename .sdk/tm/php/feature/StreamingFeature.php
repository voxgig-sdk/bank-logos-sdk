...
// BankLogos SDK streaming feature
...
class BankLogosStreamingFeature extends BankLogosBaseFeature
{
    ...
    private function _iterate(BankLogosResult $result): \Generator
    {
    ...
    private function _streamable(BankLogosContext $ctx): bool
    {
