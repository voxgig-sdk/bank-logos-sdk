...
// BankLogos SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class BankLogosTestFeature extends BankLogosBaseFeature
{
    ...
    public function init(BankLogosContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (BankLogosContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = BankLogosParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (BankLogosContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(BankLogosContext $ctx, $op, $args): array
    {
