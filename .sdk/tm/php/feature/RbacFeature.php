...
class BankLogosRbacFeature extends BankLogosBaseFeature
{
    ...
    private function _required(BankLogosContext $ctx): ?string
    {
    ...
    private function _reject(BankLogosContext $ctx, string $required): void
    {
    ...
    private function _track(BankLogosContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
