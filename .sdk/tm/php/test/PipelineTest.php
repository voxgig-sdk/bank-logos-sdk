...
{
    private static function utility(): BankLogosUtility
    {
        return new BankLogosUtility();
    }
    ...
    private static function ctx(array $over = []): BankLogosContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new BankLogosContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new BankLogosOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof BankLogosError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new BankLogosOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = BankLogosMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new BankLogosOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = BankLogosMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new BankLogosOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = BankLogosMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BankLogosSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = BankLogosMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new BankLogosResponse([]),
            'result' => new BankLogosResult([]),
        ]);
        [, $err] = BankLogosMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new BankLogosSpec([]),
            'response' => null,
            'result' => new BankLogosResult([]),
        ]);
        [, $err] = BankLogosMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new BankLogosSpec(['step' => 's']),
            'response' => new BankLogosResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new BankLogosResult([]),
        ]);
        [, $err] = BankLogosMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new BankLogosSpec(['step' => 's']),
            'response' => new BankLogosResponse(self::resp(200, ['v' => 1])),
            'result' => new BankLogosResult([]),
        ]);
        [, $err] = BankLogosMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new BankLogosSpec(['step' => 's']),
            'response' => new BankLogosResponse(self::resp(200, ['v' => 2])),
            'result' => new BankLogosResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        BankLogosMakeResponse::call($ctx);
    ...
    {
        $preset = new BankLogosResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new BankLogosSpec([]),
            'response' => new BankLogosResponse([]),
            'result' => new BankLogosResult([]),
        ...
        [$got, $err] = BankLogosMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new BankLogosResult([])]);
        [, $err] = BankLogosMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new BankLogosSpec([]), 'result' => null]);
        [, $err] = BankLogosMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BankLogosSpec(['step' => 's']),
            'result' => new BankLogosResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new BankLogosOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BankLogosMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BankLogosSpec(['step' => 's']),
            'result' => new BankLogosResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new BankLogosOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BankLogosMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BankLogosResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new BankLogosSpec([]),
            'result' => new BankLogosResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = BankLogosMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BankLogosMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new BankLogosError('boom', 'boom');
        $utility->fetcher = function (BankLogosContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BankLogosSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = BankLogosMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (BankLogosContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = BankLogosMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(BankLogosResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (BankLogosContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BankLogosSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = BankLogosMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new BankLogosResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new BankLogosSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = BankLogosMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = BankLogosMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = BankLogosMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new BankLogosResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, BankLogosDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new BankLogosResult(['ok' => false])]);
        $this->expectException(BankLogosError::class);
        BankLogosDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new BankLogosResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', BankLogosMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        BankLogosMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new BankLogosBaseFeature();
        $b = new BankLogosBaseFeature();
        BankLogosFeatureAdd::call($ctx, $a);
        BankLogosFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): BankLogosBaseFeature
    {
        $f = new BankLogosBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        BankLogosFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?BankLogosSpec $spec): BankLogosContext
    {
    ...
    private static function auth_bags(): BankLogosSpec
    {
        return new BankLogosSpec(['headers' => [], 'query' => []]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BankLogosPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new BankLogosResponse(['headers' => null]),
            'result' => new BankLogosResult([]),
        ]);
        BankLogosResultHeaders::call($ctx);
