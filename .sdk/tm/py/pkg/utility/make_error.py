# BankLogos SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, BankLogosError):
        errmsg = err.msg
    ...
    msg = "BankLogosSDK: " + opname + ": " + errmsg
    ...
    sdk_err = BankLogosError("", msg, ctx)
