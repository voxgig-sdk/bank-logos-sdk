...
from projectname_sdk.core.control import BankLogosControl
...
class BankLogosContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, BankLogosSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, BankLogosResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BankLogosResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return BankLogosError(code, msg, self)
