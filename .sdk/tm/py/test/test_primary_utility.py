...
from projectname_sdk import BankLogosSDK
from projectname_sdk.core.spec import BankLogosSpec
from projectname_sdk.core.result import BankLogosResult
from projectname_sdk.core.response import BankLogosResponse
from projectname_sdk.core.operation import BankLogosOperation
from projectname_sdk.core.error import BankLogosError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import BankLogosBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return BankLogosError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = BankLogosSDK.test(None, None)
        ...
        class TestInitFeature(BankLogosBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(BankLogosBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = BankLogosSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = BankLogosSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = BankLogosSDK.test(None, setup_opts)
