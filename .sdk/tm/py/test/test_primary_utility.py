...
_runner = makeRunner(TEST_JSON_FILE, BankLogosSDK.test(None, None))
...
def _auth_credential():
    ...
    ctx.spec = BankLogosSpec({"headers": {}, "query": {}})
    try:
...
class TestPrimaryUtility:
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = BankLogosSDK.test(None, setup.get('a') or {})
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = BankLogosSDK.test(None, setup.get('a') or {})
