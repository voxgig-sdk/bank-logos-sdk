...
class BankLogosTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = BankLogosTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = BankLogosTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = BankLogosTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
