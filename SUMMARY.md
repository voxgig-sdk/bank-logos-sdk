...
Results: Successfully retrieved bank logo.
...
| --- | --- | --- | --- |
| Logo | `load` | `GET /logo` | Required |

## Connect to the API

- Production server: `https://api.bankconv.com`
...
- `bank-logos_list`: List records for an entity. No active entity supports this operation.
- `bank-logos_load`: Load one record for an entity. Supported entities: `logo`.
