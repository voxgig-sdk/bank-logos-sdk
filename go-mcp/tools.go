...
type Args struct {
	Entity string         `json:"entity" jsonschema:"logo"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.BankLogosSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "bank-logos_list",
		Description: "List records from BankLogos. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "bank-logos_load",
		Description: "Load a single record from BankLogos. " +
...
func runOp(client *sdk.BankLogosSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.BankLogosSDK, name string) (sdk.BankLogosEntity, error) {
