...
The PHP SDK for the BankLogos API — an entity-oriented client using PHP conventions.
...
```
php/
├── banklogos_sdk.php          -- Main SDK class
...
The main class (`banklogos_sdk.php`) exports the SDK class
