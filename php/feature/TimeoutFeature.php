...
class BankLogosTimeoutFeature extends BankLogosBaseFeature
{
    ...
    private function _with_timeout(BankLogosContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BankLogosContext $_ctx, float $ms): void
    {
        $client = $this->client;
