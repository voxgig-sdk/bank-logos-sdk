...
class BankLogosProxyFeature extends BankLogosBaseFeature
{
    ...
    public function init(BankLogosContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BankLogosContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
