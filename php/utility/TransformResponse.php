...
// BankLogos SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class BankLogosTransformResponse
{
    public static function call(BankLogosContext $ctx): mixed
    {
        ...
        $transform = BankLogosHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
