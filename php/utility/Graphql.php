...
class BankLogosGraphql
{
    ...
    // equivalent.
    public static function body(BankLogosContext $ctx): mixed
    {
    ...
    public static function errors(BankLogosContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
