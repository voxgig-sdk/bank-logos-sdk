...
// BankLogos SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BankLogosSDK::test)
...
{
    private const SDK_CLASS = 'BankLogosSDK';
    ...
    private const SDK_BASE = 'banklogos_sdk';
