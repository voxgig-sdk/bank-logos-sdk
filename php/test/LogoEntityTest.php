...
class LogoEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set BANKLOGOS_TEST_LOGO_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function logo_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("BANKLOGOS_TEST_LOGO_ENTID");
    ...
    return [
        ...
        "env" => $env,
        "explain" => $env["BANKLOGOS_TEST_EXPLAIN"] === "TRUE",
        "live" => $live,
