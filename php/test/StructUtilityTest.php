...
// BankLogos SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = BankLogosOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(BankLogosOmni::structfix($now, Struct::undef()))
                        !== json_encode(BankLogosOmni::structfix($val, Struct::undef()))) {
